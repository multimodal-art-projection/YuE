...
# fp32 is neccessary to align with generatino by huggingface transformers
...
if not args.disable_offload_model:
    ...
    print("Successfully delete the stage1 model and free the GPU memory!")

print("Stage 2 inference...") # 02:56
